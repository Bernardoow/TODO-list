...
var _user$project$Data_Task$taskUpdatePositionEncoder = function (position) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'positionOrder',
				_1: _elm_lang$core$Json_Encode$int(position)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Data_Task$taskUpdateEncoder = F3(
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'status',
							_1: _elm_lang$core$Json_Encode$string(status)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Data_Task$taskCreateEncoder = F2(
...
var _user$project$Data_Task$Task = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {id: a, title: b, description: c, openDate: d, status: e, isRemoved: f, positionOrder: g, completedDate: h, positionOrderDateUpdated: i};
	});
var _user$project$Data_Task$taskDecoder = A3(
...
var _user$project$Data_Task$tasksDecoder = _elm_lang$core$Json_Decode$list(_user$project$Data_Task$taskDecoder);
var _user$project$Data_Task$TaskDataResult = F4(
	function (a, b, c, d) {
		return {count: a, next: b, previous: c, list: d};
	});
var _user$project$Data_Task$dataTaskDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'results',
	_user$project$Data_Task$tasksDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'previous',
		_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$string),
		A3(
			...
			A3(
				...
				'count',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Data_Task$TaskDataResult)))));

var _user$project$Request_Util$baseUrl = '/tasks/';

var _user$project$Request_Task$deleteTask = function (id) {
	var idStr = _elm_lang$core$Basics$toString(id);
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Request_Util$baseUrl,
		A2(_elm_lang$core$Basics_ops['++'], idStr, '/destroy'));
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$Data_Task$taskDecoder),
			_lukewestby$elm_http_builder$HttpBuilder$delete(url)));
};
var _user$project$Request_Task$updateTask = F2(
	function (id, params) {
		var idStr = _elm_lang$core$Basics$toString(id);
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Request_Util$baseUrl,
			A2(_elm_lang$core$Basics_ops['++'], idStr, '/update'));
		return _lukewestby$elm_http_builder$HttpBuilder$toTask(
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withExpect,
				_elm_lang$http$Http$expectJson(_user$project$Data_Task$taskDecoder),
				A2(
					...
					params,
					_lukewestby$elm_http_builder$HttpBuilder$patch(url))));
	});
var _user$project$Request_Task$retrieveTask = function (id) {
	var idStr = _elm_lang$core$Basics$toString(id);
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Request_Util$baseUrl,
		A2(_elm_lang$core$Basics_ops['++'], idStr, '/'));
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$Data_Task$taskDecoder),
...
var _user$project$Request_Task$getTasks = function (urlParams) {
	var url = function () {
		var _p0 = urlParams;
		if (_p0.ctor === 'Nothing') {
			return A2(_elm_lang$core$Basics_ops['++'], _user$project$Request_Util$baseUrl, 'list/');
		} else {
			return _p0._0;
		}
	}();
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$Data_Task$dataTaskDecoder),
			_lukewestby$elm_http_builder$HttpBuilder$get(url)));
};
var _user$project$Request_Task$createTask = function (params) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Request_Util$baseUrl, 'new-task/');
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$Data_Task$taskDecoder),
...
var _user$project$Route$Task = function (a) {
	return {ctor: 'Task', _0: a};
};
var _user$project$Route$NewTask = {ctor: 'NewTask'};
...
var _user$project$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Route$NewTask,
				_evancz$url_parser$UrlParser$s('newTask')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Route$Task,
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('task'),
...
var _user$project$Route$fromLocation = function (location) {
	var el = A2(_elm_lang$core$Debug$log, '', location);
...
var _user$project$Page_TaskBoard$customComp = F2(
	function (item, item2) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Basics$compare, item.positionOrder, item2.positionOrder),
			_1: A2(_elm_lang$core$Basics$compare, item.positionOrderDateUpdated, item2.positionOrderDateUpdated)
		};
		if (_p0._0.ctor === 'EQ') {
			var _p1 = _p0._1;
			switch (_p1.ctor) {
...
var _user$project$Page_TaskBoard$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Page_TaskBoard$Model = F4(
	function (a, b, c, d) {
		return {alert_messages: a, tasksData: b, loadingTasks: c, dragDrop: d};
	});
var _user$project$Page_TaskBoard$initModel = A4(_user$project$Page_TaskBoard$Model, _Bernardoow$elm_alert_timer_message$AlertTimerMessage$modelInit, _elm_lang$core$Maybe$Nothing, true, _norpan$elm_html5_drag_drop$Html5_DragDrop$init);
var _user$project$Page_TaskBoard$OpenTaskDetails = function (a) {
	return {ctor: 'OpenTaskDetails', _0: a};
};
var _user$project$Page_TaskBoard$CreateNewTask = {ctor: 'CreateNewTask'};
var _user$project$Page_TaskBoard$DragDropMsg = function (a) {
	return {ctor: 'DragDropMsg', _0: a};
};
var _user$project$Page_TaskBoard$viewTaskEntry = function (_p2) {
	var _p3 = _p2;
	var _p6 = _p3._1;
	var _p5 = _p3._0;
	var css2 = {
		...
		_1: A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$draggable, _user$project$Page_TaskBoard$DragDropMsg, _p6.id)
	};
	var css = {
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('col-md-4 col-xs-6 col-sm-4 col-lg-4'),
		_1: A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$droppable, _user$project$Page_TaskBoard$DragDropMsg, _p5)
	};
	var date = _elm_lang$core$Date$fromString(_p6.openDate);
	return A2(
		_elm_lang$html$Html$div,
		css,
		{
									...
									_0: A2(
										...
										},
										{
											...
											_0: function () {
												var _p4 = date;
												if (_p4.ctor === 'Ok') {
													var date_text = A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_pt_br$config, _rluiten$elm_date_extra$Date_Extra_Config_Config_pt_br$config.format.dateTime, _p4._0);
													return A2(
														_elm_lang$html$Html$div,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('col-md-5 col-xs-5 col-sm-5 col-lg-5'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																...
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Data Abertura:'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}),
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(date_text),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('col-md-3 col-xs-3 col-sm-3 col-lg-3'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$i,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('fa fa-list-ol'),
																	_1: {ctor: '[]'}
																}
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Posição:'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('col-md-2 col-xs-2 col-sm-2 col-lg-2'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
																...
																_elm_lang$html$Html$button,
																{
																	...
																	_1: {
																		...
																		_0: _elm_lang$html$Html_Events$onClick(
																			_user$project$Page_TaskBoard$OpenTaskDetails(_p6.id)),
																		_1: {
																			ctor: '::',
...
var _user$project$Page_TaskBoard$viewTaskBoard = function (model) {
	if (model.loadingTasks) {
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$div,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Carregando as tarefas...'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		};
	} else {
		var _p7 = model.tasksData;
		if (_p7.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return A2(
				_elm_lang$core$List$map,
				_user$project$Page_TaskBoard$viewTaskEntry,
				A2(
					...
					A2(_elm_lang$core$List$sortWith, _user$project$Page_TaskBoard$customComp, _p7._0.list)));
		}
	}
};
var _user$project$Page_TaskBoard$PaginationChange = function (a) {
	return {ctor: 'PaginationChange', _0: a};
};
var _user$project$Page_TaskBoard$viewPagination = function (model) {
	if (model.loadingTasks) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: function () {
								var _p9 = _p11.previous;
								if (_p9.ctor === 'Nothing') {
									return A2(
										_elm_lang$html$Html$li,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('previous disabled'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text('Anterior'),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Page_TaskBoard$PaginationChange(_p9._0)),
														_1: {ctor: '[]'}
													}
												},
												{
								...
								_0: function () {
									...
									if (_p10.ctor === 'Nothing') {
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('next disabled'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Próxima'),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$span,
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Page_TaskBoard$PaginationChange(_p10._0)),
															_1: {ctor: '[]'}
														}
													},
													{
...
var _user$project$Page_TaskBoard$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('titleBoard'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Quadro de tarefas'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-md-12 col-xs-12 col-sm-12 col-lg-12'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('btnCreateNewTask'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskBoard$CreateNewTask),
											_1: {
												ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Criar Nova Tarefa'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Page_TaskBoard$viewTaskBoard(model)),
					_1: {
						ctor: '::',
						_0: _user$project$Page_TaskBoard$viewPagination(model),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Page_TaskBoard$TaskUpdatePositionResult = function (a) {
	return {ctor: 'TaskUpdatePositionResult', _0: a};
};
var _user$project$Page_TaskBoard$TasksResult = function (a) {
	return {ctor: 'TasksResult', _0: a};
};
var _user$project$Page_TaskBoard$initCmd = function () {
	var getTasks = _user$project$Request_Task$getTasks(_elm_lang$core$Maybe$Nothing);
	return {
		ctor: '::',
		_0: A2(_elm_lang$core$Task$attempt, _user$project$Page_TaskBoard$TasksResult, getTasks),
		_1: {ctor: '[]'}
	};
}();
var _user$project$Page_TaskBoard$init = function () {
	var model = _user$project$Page_TaskBoard$initModel;
	return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, _user$project$Page_TaskBoard$initCmd);
}();
var _user$project$Page_TaskBoard$AlertTimer = function (a) {
	return {ctor: 'AlertTimer', _0: a};
};
var _user$project$Page_TaskBoard$update = F2(
	function (msg, model) {
		var _p12 = msg;
		switch (_p12.ctor) {
			case 'AlertTimer':
				var _p13 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, _p12._0, model.alert_messages);
				var updateModel = _p13._0;
				var subCmd = _p13._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{alert_messages: updateModel}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Page_TaskBoard$AlertTimer, subCmd),
						_1: {ctor: '[]'}
					});
			case 'TasksResult':
				if (_p12._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								tasksData: _elm_lang$core$Maybe$Just(_p12._0._0),
								loadingTasks: false
							}),
						{ctor: '[]'});
				} else {
			...
			case 'TaskUpdatePositionResult':
				if (_p12._0.ctor === 'Ok') {
					var _p16 = _p12._0._0;
					var _p14 = model.tasksData;
					if (_p14.ctor === 'Nothing') {
						...
						var list = A2(
							_elm_lang$core$List$map,
							function (item) {
								return _elm_lang$core$Native_Utils.eq(item.id, _p16.id) ? _p16 : item;
							},
							_p15.list);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									tasksData: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Native_Utils.update(
											_p15,
											{list: list}))
								}),
			...
			case 'PaginationChange':
				var getTasks = _user$project$Request_Task$getTasks(
			...
			case 'DragDropMsg':
				var _p17 = A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$update, _p12._0, model.dragDrop);
				var model_ = _p17._0;
				var result = _p17._1;
				var _p18 = function () {
					var _p19 = model.tasksData;
					if (_p19.ctor === 'Nothing') {
						...
						var cmds = function () {
							...
							if (_p20.ctor === 'Nothing') {
								...
								var id = _p21._0;
								var pos = _p21._1;
								var params = _user$project$Data_Task$taskUpdatePositionEncoder(pos);
								var updateTask = A2(_user$project$Request_Task$updateTask, id, params);
								var maybeTask = _elm_lang$core$List$head(
									A2(
										_elm_lang$core$List$filter,
										function (_p22) {
											var _p23 = _p22;
											return _elm_lang$core$Native_Utils.eq(_p23._0, pos);
										},
										A2(
											_elm_lang$core$List$indexedMap,
											F2(
											...
											A2(_elm_lang$core$List$sortWith, _user$project$Page_TaskBoard$customComp, _p27.list))));
								var newCmd = function () {
									var _p24 = maybeTask;
									if (_p24.ctor === 'Nothing') {
										return _elm_lang$core$Platform_Cmd$none;
									} else {
										var params = _user$project$Data_Task$taskUpdatePositionEncoder(_p24._0._0 + 1);
										var request = A2(_user$project$Request_Task$updateTask, _p24._0._1.id, params);
										return A2(_elm_lang$core$Task$attempt, _user$project$Page_TaskBoard$TaskUpdatePositionResult, request);
									}
								}();
								return {
									ctor: '::',
									_0: A2(_elm_lang$core$Task$attempt, _user$project$Page_TaskBoard$TaskUpdatePositionResult, updateTask),
									_1: {
										ctor: '::',
										_0: newCmd,
										_1: {ctor: '[]'}
				...
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							_user$project$Route$routeToString(_user$project$Route$NewTask)),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							_user$project$Route$routeToString(
								_user$project$Route$Task(_p12._0))),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Page_TaskBoard$main = _elm_lang$html$Html$program(
	{init: _user$project$Page_TaskBoard$init, view: _user$project$Page_TaskBoard$view, update: _user$project$Page_TaskBoard$update, subscriptions: _user$project$Page_TaskBoard$subscriptions})();

var _user$project$Page_TaskCreate$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Page_TaskCreate$Model = F3(
	function (a, b, c) {
		return {title: a, description: b, alert_messages: c};
	});
var _user$project$Page_TaskCreate$initModel = A3(_user$project$Page_TaskCreate$Model, '', '', _Bernardoow$elm_alert_timer_message$AlertTimerMessage$modelInit);
var _user$project$Page_TaskCreate$init = function () {
	var model = _user$project$Page_TaskCreate$initModel;
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
}();
var _user$project$Page_TaskCreate$GoToBoard = {ctor: 'GoToBoard'};
var _user$project$Page_TaskCreate$TaskResult = function (a) {
	return {ctor: 'TaskResult', _0: a};
};
var _user$project$Page_TaskCreate$AlertTimer = function (a) {
	return {ctor: 'AlertTimer', _0: a};
};
var _user$project$Page_TaskCreate$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'TitleInput':
			...
			case 'DescriptionInput':
				return A2(
					...
					{ctor: '[]'});
			case 'Save':
				if (_elm_lang$core$String$isEmpty(model.title)) {
					var newMsg = A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Clique cancelado. Inseria um título.'),
								_1: {ctor: '[]'}
							}));
					...
					return A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Page_TaskCreate$AlertTimer, subCmd),
							_1: {ctor: '[]'}
						});
				} else {
					if (_elm_lang$core$Native_Utils.cmp(
						_elm_lang$core$String$length(model.title),
						255) > 0) {
						var newMsg = A2(
							_Bernardoow$elm_alert_timer_message$AlertTimerMessage$AddNewMessage,
							5,
							A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Clique cancelado. Reduza o título.'),
									_1: {ctor: '[]'}
								}));
						var _p2 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, newMsg, model.alert_messages);
						...
						if (_elm_lang$core$String$isEmpty(model.description)) {
							var newMsg = A2(
								_Bernardoow$elm_alert_timer_message$AlertTimerMessage$AddNewMessage,
								5,
								A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Clique cancelado. Inseria uma descrição.'),
										_1: {ctor: '[]'}
									}));
							var _p3 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, newMsg, model.alert_messages);
							...
							var value = A2(_user$project$Data_Task$taskCreateEncoder, model.title, model.description);
							var request = _user$project$Request_Task$createTask(value);
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
								{
									ctor: '::',
									_0: A2(_elm_lang$core$Task$attempt, _user$project$Page_TaskCreate$TaskResult, request),
									_1: {ctor: '[]'}
								});
						}
					}
			...
			case 'AlertTimer':
				var _p4 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, _p0._0, model.alert_messages);
				...
				if (_p0._0.ctor === 'Ok') {
					var cmd = A2(
						...
						A2(
							_elm_lang$core$Task$andThen,
							_elm_lang$core$Basics$always(
								_elm_lang$core$Task$succeed(_user$project$Page_TaskCreate$GoToBoard)),
					...
					var newMsg = A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Tarefa criada com sucesso!'),
								_1: {ctor: '[]'}
							}));
					var _p5 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, newMsg, model.alert_messages);
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{title: '', description: '', alert_messages: updateModel}),
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Page_TaskCreate$AlertTimer, subCmd),
							_1: {
					...
					var elm = A2(_elm_lang$core$Debug$log, 'da', _p0._0._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
			...
			default:
				return A2(
					...
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(
							_user$project$Route$routeToString(_user$project$Route$Home)),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Page_TaskCreate$Save = {ctor: 'Save'};
var _user$project$Page_TaskCreate$DescriptionInput = function (a) {
	return {ctor: 'DescriptionInput', _0: a};
};
var _user$project$Page_TaskCreate$TitleInput = function (a) {
	return {ctor: 'TitleInput', _0: a};
};
var _user$project$Page_TaskCreate$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Nota tarefa'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-sm-offset-2 col-sm-10  col-md-offset-2 col-md-10  col-xs-offset-2 col-xs-10  col-lg-offset-2 col-lg-10'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskCreate$GoToBoard),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('btn btn-primary pull-right'),
											_1: {ctor: '[]'}
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Voltar para o quadro de tarefas.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Page_TaskCreate$AlertTimer,
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('col-sm-2 control-label col-xs-2 col-md-2 col-lg-2'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$for('inputTitle'),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Título'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('col-md-10 col-xs-10 col-sm-10 col-lg-10'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Page_TaskCreate$TitleInput),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('form-control'),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$id('inputTitle'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$placeholder('Digite o título da tarefa.'),
																			_1: {
																				ctor: '::',
													...
													_1: {
														...
														_0: (_elm_lang$core$Native_Utils.cmp(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Atenção. O título ultrapassou limite máximo de 255 caracteres.'),
																_1: {ctor: '[]'}
															}) : A2(
															_elm_lang$html$Html$div,
															{ctor: '[]'},
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$label,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$for('inputDescription'),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Descrição'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$id('inputDescription'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(model.description),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(_user$project$Page_TaskCreate$DescriptionInput),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('form-control'),
																			_1: {
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$placeholder('Descreva a tarefa.'),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('btnSave'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskCreate$Save),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('btn btn-default'),
															_1: {ctor: '[]'}
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Salvar'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$Page_TaskCreate$main = _elm_lang$html$Html$program(
	{init: _user$project$Page_TaskCreate$init, view: _user$project$Page_TaskCreate$view, update: _user$project$Page_TaskCreate$update, subscriptions: _user$project$Page_TaskCreate$subscriptions})();

var _user$project$Page_TaskEdit$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Page_TaskEdit$onChange = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$targetValue));
};
var _user$project$Page_TaskEdit$Model = F6(
	function (a, b, c, d, e, f) {
		return {task: a, title: b, description: c, status: d, showModalConfirmation: e, alert_messages: f};
	});
var _user$project$Page_TaskEdit$initModel = A6(_user$project$Page_TaskEdit$Model, _elm_lang$core$Maybe$Nothing, '', '', '', false, _Bernardoow$elm_alert_timer_message$AlertTimerMessage$modelInit);
var _user$project$Page_TaskEdit$UpdatedTask = {ctor: 'UpdatedTask'};
var _user$project$Page_TaskEdit$LoadingTask = {ctor: 'LoadingTask'};
var _user$project$Page_TaskEdit$GoToBoard = {ctor: 'GoToBoard'};
var _user$project$Page_TaskEdit$Delete = {ctor: 'Delete'};
var _user$project$Page_TaskEdit$ToogleShowModalConfirmation = {ctor: 'ToogleShowModalConfirmation'};
var _user$project$Page_TaskEdit$viewCheckDeleteOK = function (model) {
	return model.showModalConfirmation ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Confirma a remoção da tarefa'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Deseja deletar essa tarefa?'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskEdit$Delete),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('btn btn-default'),
												_1: {ctor: '[]'}
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Sim'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskEdit$ToogleShowModalConfirmation),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('btn btn-default'),
														_1: {ctor: '[]'}
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Não'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Page_TaskEdit$TaskResult = F2(
	function (a, b) {
		return {ctor: 'TaskResult', _0: a, _1: b};
	});
var _user$project$Page_TaskEdit$initCmd = function (id) {
	var getTask = _user$project$Request_Task$retrieveTask(id);
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$core$Task$attempt,
			_user$project$Page_TaskEdit$TaskResult(_user$project$Page_TaskEdit$LoadingTask),
			getTask),
		_1: {ctor: '[]'}
	};
};
var _user$project$Page_TaskEdit$init = function () {
	var model = _user$project$Page_TaskEdit$initModel;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		model,
		_user$project$Page_TaskEdit$initCmd(1));
}();
var _user$project$Page_TaskEdit$AlertTimer = function (a) {
	return {ctor: 'AlertTimer', _0: a};
};
var _user$project$Page_TaskEdit$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'TitleInput':
			...
			case 'Save':
				if (_elm_lang$core$String$isEmpty(model.title)) {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Page_TaskEdit$AlertTimer, subCmd),
							_1: {ctor: '[]'}
						});
				} else {
					if (_elm_lang$core$Native_Utils.cmp(
						...
						if (_elm_lang$core$String$isEmpty(model.description)) {
							...
							if (_p4.ctor === 'Nothing') {
								...
								var value = A3(_user$project$Data_Task$taskUpdateEncoder, model.title, model.description, model.status);
								var request = A2(_user$project$Request_Task$updateTask, _p4._0.id, value);
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{
										...
										_0: A2(
											_elm_lang$core$Task$attempt,
											_user$project$Page_TaskEdit$TaskResult(_user$project$Page_TaskEdit$UpdatedTask),
											request),
										_1: {ctor: '[]'}
									});
							}
			...
			case 'AlertTimer':
				var _p5 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, _p0._0, model.alert_messages);
				var updateModel = _p5._0;
				var subCmd = _p5._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'TaskResult':
				if (_p0._1.ctor === 'Ok') {
					var _p8 = _p0._1._0;
					var _p6 = _p0._0;
					if (_p6.ctor === 'LoadingTask') {
						var status = _elm_lang$core$Basics$toString(_p8.status);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									task: _elm_lang$core$Maybe$Just(_p8),
									title: _p8.title,
									description: _p8.description,
									status: status
								}),
							{ctor: '[]'});
					} else {
						var cmd = A2(
							...
							A2(
								_elm_lang$core$Task$andThen,
								_elm_lang$core$Basics$always(
									_elm_lang$core$Task$succeed(_user$project$Page_TaskEdit$GoToBoard)),
								_elm_lang$core$Process$sleep(_elm_lang$core$Time$second * 2)));
						var status = _elm_lang$core$Basics$toString(_p8.status);
						var newMsg = A2(
							_Bernardoow$elm_alert_timer_message$AlertTimerMessage$AddNewMessage,
							5,
							A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Tarefa editada com sucesso!'),
									_1: {ctor: '[]'}
								}));
						var _p7 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, newMsg, model.alert_messages);
						var updateModel = _p7._0;
						var subCmd = _p7._1;
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
					...
					var el = A2(_elm_lang$core$Debug$log, 'err', _p0._1._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
			...
			case 'StatusInput':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{status: _p0._0}),
					{ctor: '[]'});
			case 'ToogleShowModalConfirmation':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{showModalConfirmation: !model.showModalConfirmation}),
					{ctor: '[]'});
			case 'Delete':
				var _p9 = model.task;
				if (_p9.ctor === 'Nothing') {
					...
					var newMsg = A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Tarefa deletada com sucesso!'),
								_1: {ctor: '[]'}
							}));
					var _p10 = A2(_Bernardoow$elm_alert_timer_message$AlertTimerMessage$update, newMsg, model.alert_messages);
					var updateModel = _p10._0;
					var subCmd = _p10._1;
					var request = _user$project$Request_Task$deleteTask(_p9._0.id);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{alert_messages: updateModel, showModalConfirmation: false}),
						{
							ctor: '::',
							_0: A2(
								_elm_lang$core$Task$attempt,
...
var _user$project$Page_TaskEdit$Save = {ctor: 'Save'};
var _user$project$Page_TaskEdit$StatusInput = function (a) {
	return {ctor: 'StatusInput', _0: a};
};
var _user$project$Page_TaskEdit$DescriptionInput = function (a) {
	return {ctor: 'DescriptionInput', _0: a};
};
var _user$project$Page_TaskEdit$TitleInput = function (a) {
	return {ctor: 'TitleInput', _0: a};
};
var _user$project$Page_TaskEdit$view = function (model) {
	var _p11 = model.task;
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Editar tarefa'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskEdit$GoToBoard),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('btn btn-primary pull-right'),
												_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$Page_TaskEdit$AlertTimer,
							_Bernardoow$elm_alert_timer_message$AlertTimerMessage$view(model.alert_messages)),
						_1: {
							ctor: '::',
							_0: A2(
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_user$project$Page_TaskEdit$TitleInput),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('form-control'),
																		_1: {
															...
															_0: A2(
																_elm_lang$html$Html$textarea,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_user$project$Page_TaskEdit$DescriptionInput),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('form-control'),
																				_1: {
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('col-sm-2 control-label'),
															_1: {
																ctor: '::',
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _user$project$Page_TaskEdit$onChange(_user$project$Page_TaskEdit$StatusInput),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('form-control'),
																			_1: {ctor: '[]'}
																		...
																		_0: A2(
																			_elm_lang$html$Html$option,
																			{
																				...
																				_0: _elm_lang$html$Html_Attributes$selected(
																					_elm_lang$core$Native_Utils.eq('1', model.status)),
																				_1: {
																					ctor: '::',
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Aberta'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_elm_lang$html$Html$option,
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$selected(
																						_elm_lang$core$Native_Utils.eq('2', model.status)),
																					_1: {
																						ctor: '::',
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Feitas'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
							...
							_1: {
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskEdit$Save),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('btn btn-default'),
																_1: {ctor: '[]'}
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('btnDelete'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_TaskEdit$ToogleShowModalConfirmation),
																_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Page_TaskEdit$viewCheckDeleteOK(model),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Page_TaskEdit$main = _elm_lang$html$Html$program(
	{init: _user$project$Page_TaskEdit$init, view: _user$project$Page_TaskEdit$view, update: _user$project$Page_TaskEdit$update, subscriptions: _user$project$Page_TaskEdit$subscriptions})();
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {page: a, boardModel: b, createModel: c, editModel: d};
	});
var _user$project$Main$model = A4(_user$project$Main$Model, _user$project$Route$Home, _user$project$Page_TaskBoard$initModel, _user$project$Page_TaskCreate$initModel, _user$project$Page_TaskEdit$initModel);
var _user$project$Main$TaskEdit = function (a) {
	return {ctor: 'TaskEdit', _0: a};
};
var _user$project$Main$TaskCreate = function (a) {
	return {ctor: 'TaskCreate', _0: a};
};
var _user$project$Main$TaskBoard = function (a) {
	return {ctor: 'TaskBoard', _0: a};
};
var _user$project$Main$urlChangeProcess = F2(
				...
				switch (_p1._0.ctor) {
					case 'NewTask':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{page: _user$project$Route$NewTask}),
							{ctor: '[]'});
					case 'Home':
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
								...
								{page: _user$project$Route$Home}),
							{
								...
								_0: A2(
									...
									_user$project$Main$TaskBoard,
									_elm_lang$core$Platform_Cmd$batch(_user$project$Page_TaskBoard$initCmd)),
								_1: {ctor: '[]'}
							});
					default:
						var _p2 = _p1._0._0;
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									page: _user$project$Route$Task(_p2)
								}),
							{
								ctor: '::',
								_0: A2(
									_elm_lang$core$Platform_Cmd$map,
									_user$project$Main$TaskEdit,
									_elm_lang$core$Platform_Cmd$batch(
										_user$project$Page_TaskEdit$initCmd(_p2))),
								_1: {ctor: '[]'}
							});
				}
			}
		}();
		var modelUpdate = _p0._0;
		var subcmd = _p0._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			modelUpdate,
...
var _user$project$Main$init = function (location) {
	var _p3 = A2(
		_user$project$Main$urlChangeProcess,
		_user$project$Main$model,
		_user$project$Route$fromLocation(location));
	var modelUpdate = _p3._0;
	var newCmd = _p3._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		modelUpdate,
		...
		switch (_p4.ctor) {
			...
			case 'UrlChange':
				var _p5 = A2(
					_user$project$Main$urlChangeProcess,
					model,
					_user$project$Route$fromLocation(_p4._0));
				var modelUpdate = _p5._0;
				var newCmd = _p5._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					modelUpdate,
			...
			case 'TaskBoard':
				var _p6 = A2(_user$project$Page_TaskBoard$update, _p4._0, model.boardModel);
				var modelAtualizado = _p6._0;
				var subCmd = _p6._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{boardModel: modelAtualizado}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$TaskBoard, subCmd),
						_1: {ctor: '[]'}
					});
			case 'TaskCreate':
				var _p7 = A2(_user$project$Page_TaskCreate$update, _p4._0, model.createModel);
				var modelAtualizado = _p7._0;
				var subCmd = _p7._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{createModel: modelAtualizado}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$TaskCreate, subCmd),
						_1: {ctor: '[]'}
					});
			default:
				var _p8 = A2(_user$project$Page_TaskEdit$update, _p4._0, model.editModel);
				var modelAtualizado = _p8._0;
				var subCmd = _p8._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{editModel: modelAtualizado}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$TaskEdit, subCmd),
						_1: {ctor: '[]'}
					});
		}
	});
				...
				switch (_p9.ctor) {
					case 'Home':
						return A2(
							_elm_lang$html$Html$map,
							_user$project$Main$TaskBoard,
							_user$project$Page_TaskBoard$view(model.boardModel));
					case 'NewTask':
						return A2(
							_elm_lang$html$Html$map,
							_user$project$Main$TaskCreate,
							_user$project$Page_TaskCreate$view(model.createModel));
					default:
						return A2(
							_elm_lang$html$Html$map,
							_user$project$Main$TaskEdit,
							_user$project$Page_TaskEdit$view(model.editModel));
				}
			}(),
			_1: {ctor: '[]'}
		});
